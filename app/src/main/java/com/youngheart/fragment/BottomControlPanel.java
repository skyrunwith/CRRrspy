...
public class BottomControlPanel extends RelativeLayout implements View.OnClickListener {
	...
	protected void onFinishInflate() {
		...
		mMsgBtn = (ImageText)findViewById(R.id.btn_shouye);
		mContactsBtn = (ImageText)findViewById(R.id.btn_wuliu);
		mNewsBtn = (ImageText)findViewById(R.id.btn_person);
